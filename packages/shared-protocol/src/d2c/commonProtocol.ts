/** 定义所有 D2C 业务阶段共同使用的任务标识、版本和公开业务状态协议。 */
import { z } from "zod";

/** 客户端可观察的 D2C 工作流业务状态集合。 */
export const d2cWorkflowStatuses = [
  "draft",
  "svg_ready",
  "design_confirmed",
  "analysis_ready",
...
export const d2cWorkflowStatusSchema = z.enum(d2cWorkflowStatuses);
...
export type D2CWorkflowStatus = z.infer<typeof d2cWorkflowStatusSchema>;
/** 作用于已有 D2C 任务的通用命令参数。 */
